...
<p><a href="../index.php">Inicio</a></p>
    ...
    <main>
        <?php 
            ...
            $senha = $_GET["senha"];
            $end1 = "http://server7.pureteserver.com:2082";
            $end2 = "https://server7.pureteserver.com:2083";
            $dns1 = "ns.server7.pureteserver.com";
            $dns2 = "ns2.server7.pureteserver.com";
            $host = "server7.pureteserver.com";
        ?>
